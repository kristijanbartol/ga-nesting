...
\begin{enumerate}
    ...
    \item We analyse the search landscape induced by the mesh-based
          formulation and evaluate on garments of up to $M=11$ patches
          with layouts of up to 1{,}100 pattern pieces across 20
          independent seeds, demonstrating consistent improvement over
          all baselines.
\end{enumerate}
