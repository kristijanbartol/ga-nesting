...
\begin{enumerate}
    ...
    \item We demonstrate scalability to layouts of up to 400 pattern pieces
          ($N=100$ bodies $\times$ $M=4$ patches) and robustness across
          three garment types: pants, sleeveless shirt, and sleeveless onesie.
\end{enumerate}
