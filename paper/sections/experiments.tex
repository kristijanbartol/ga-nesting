...
and retains the best-found individual.
The sample count is set equal to the GA's evaluation budget
($\mathrm{pop} \times \mathrm{gens} = 2{,}000$), so B3 and the GA use
identical computation, identical evaluator, and identical search space;
they differ only in how they move through it.
B3 is therefore the strongest available test of whether population-based
search is necessary: any improvement of the GA over B3 is attributable
to selection, crossover, and variable-specific mutation, and cannot be
explained by a larger search space or a stronger evaluator.
...
pipeline and the same Stage~2 solver; any improvement of the GA over B3
is therefore attributable to the evolutionary operators, selection,
crossover, and variable-specific mutation, and cannot be explained by a
larger search space or a stronger evaluator.
